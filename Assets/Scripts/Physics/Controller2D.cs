...
namespace AttackOnTap.Physics
{
    public class Controller2D : RayCastController
    {
        ...
        void DescendSlope(ref Vector2 moveAmount)
        {
            ...
            {
                SliderDownMaxSlope(maxSlopeHitLeft, ref moveAmount);
                SliderDownMaxSlope(maxSlopeHitRight, ref moveAmount);
            }
        ...
        void SliderDownMaxSlope(RaycastHit2D hit, ref Vector2 moveAmount)
        {
            if (hit)
            {
                float slopeAngle = Vector2.Angle(hit.normal, Vector2.up);
